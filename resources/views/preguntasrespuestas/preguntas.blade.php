    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-12">
                ...
                <h2 class="mb-2 display-5 text-start fw-bolder" id="titulo">Preguntas & Respuestas </h2>
...
@push('scripts')
<script type="module" src=" {{asset('assets/js/preguntasrespuestas/preguntas.js')}}"></script>
@endpush
