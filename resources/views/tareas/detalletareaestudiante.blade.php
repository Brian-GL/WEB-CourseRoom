...
@push('styles')
<link rel="stylesheet" href="{{ asset ('build/assets/detalletareaestudiante.866167fd.css')}}">
@endpush
...
@push('scripts')
<script type="module" src=" {{asset('build/assets/detalletareaestudiante.dcb945af.js')}}"></script>
@endpush
