                                ...
                                <div class="col-md-6">
                                    @if (!is_null($DatosCurso))
                                        ...
                                        <div class="mt-1">
                                            ...
                                            <span class="fuenteNormal tercer-color-letra"><u>{{$DatosCurso->descripcionEstatus}}</u></span>
                                        </div>
                                        <div class="mt-2 mb-4">
                                        ...
                                        <form method="HEAD" id="form-cuestionario">
                                            ...
                                            <div class="row g-3 mt-2">
                                                <div class="col-md-12">
                                                    ...
                                                    <select id="pregunta-1" class="form-select primer-color-letra primer-color-fondo" required>
                                            ...
                                            <div class="row g-3 mt-2">
                                                <div class="col-md-12">
                                                    ...
                                                    <select id="pregunta-2" class="form-select primer-color-letra primer-color-fondo" required>
                                                    <option value="1">Casi Nunca</option>
                                                        <option value="2">Rara Vez</option>
                                                        <option value="3">Alguna Vez</option>
                                                        <option value="4">A Menudo</option>
                                            ...
                                            <div class="row g-3 mt-2">
                                                <div class="col-md-12">
                                                    ...
                                                    <select id="pregunta-3" class="form-select primer-color-letra primer-color-fondo" required>
                                                        <option value="1">Casi Nunca</option>
                                                        <option value="2">Rara Vez</option>
                                                        <option value="3">Alguna Vez</option>
                                                        <option value="4">A Menudo</option>
                                            ...
                                            <div class="row g-3 mt-2">
                                                <div class="col-md-12">
                                                    ...
                                                    <select id="pregunta-4" class="form-select primer-color-letra primer-color-fondo" required>
                                                        <option value="1">Casi Nunca</option>
                                                        <option value="2">Rara Vez</option>
                                                        <option value="3">Alguna Vez</option>
                                                        <option value="4">A Menudo</option>
                                            ...
                                            <div class="row g-3 mt-2">
                                                <div class="col-md-12">
                                                    ...
                                                    <select id="pregunta-5" class="form-select primer-color-letra primer-color-fondo" required>
                                                        <option value="1">Casi Nunca</option>
                                                        <option value="2">Rara Vez</option>
                                                        <option value="3">Alguna Vez</option>
                                                        <option value="4">A Menudo</option>
                                            ...
                                            <div class="row g-3 mt-2">
                                                <div class="col-md-12">
                                                    ...
                                                    <select id="pregunta-6" class="form-select primer-color-letra primer-color-fondo" required>
                                                        <option value="1">Casi Nunca</option>
                                                        <option value="2">Rara Vez</option>
                                                        <option value="3">Alguna Vez</option>
                                                        <option value="4">A Menudo</option>
                                            ...
                                            <div class="row g-3 mt-2">
                                                <div class="col-md-12">
                                                    ...
                                                    <select id="pregunta-7" class="form-select primer-color-letra primer-color-fondo" required>
                                                        <option value="1">Casi Nunca</option>
                                                        <option value="2">Rara Vez</option>
                                                        <option value="3">Alguna Vez</option>
                                                        <option value="4">A Menudo</option>
                                            ...
                                            <div class="row g-3 mt-2">
                                                <div class="col-md-12">
                                                    ...
                                                    <select id="pregunta-8" class="form-select primer-color-letra primer-color-fondo" required>
                                                        <option value="1">Casi Nunca</option>
                                                        <option value="2">Rara Vez</option>
                                                        <option value="3">Alguna Vez</option>
                                                        <option value="4">A Menudo</option>
                                            ...
                                            <div class="row g-3 mt-2">
                                                <div class="col-md-12">
                                                    ...
                                                    <select id="pregunta-9" class="form-select primer-color-letra primer-color-fondo" required>
                                                        <option value="1">Casi Nunca</option>
                                                        <option value="2">Rara Vez</option>
                                                        <option value="3">Alguna Vez</option>
                                                        <option value="4">A Menudo</option>
                                            ...
                                            <div class="row g-3 mt-2">
                                                <div class="col-md-12">
                                                    ...
                                                    <select id="pregunta-10" class="form-select primer-color-letra primer-color-fondo" required>
                                                        <option value="1">Casi Nunca</option>
                                                        <option value="2">Rara Vez</option>
                                                        <option value="3">Alguna Vez</option>
                                                        <option value="4">A Menudo</option>
                                            ...
                                            <div class="row g-3 mt-2">
                                                <div class="col-md-12">
                                                    ...
                                                    <select id="pregunta-11" class="form-select primer-color-letra primer-color-fondo" required>
                                                        <option value="1">Casi Nunca</option>
                                                        <option value="2">Rara Vez</option>
                                                        <option value="3">Alguna Vez</option>
                                                        <option value="4">A Menudo</option>
                                            ...
                                            <div class="row g-3 mt-2">
                                                <div class="col-md-12">
                                                    ...
                                                    <select id="pregunta-12" class="form-select primer-color-letra primer-color-fondo" required>
                                                        <option value="1">Casi Nunca</option>
                                                        <option value="2">Rara Vez</option>
                                                        <option value="3">Alguna Vez</option>
                                                        <option value="4">A Menudo</option>
                                            ...
                                            <div class="row g-3 mt-2">
                                                <div class="col-md-12">
                                                    ...
                                                    <select id="pregunta-13" class="form-select primer-color-letra primer-color-fondo" required>
                                                        <option value="1">Casi Nunca</option>
                                                        <option value="2">Rara Vez</option>
                                                        <option value="3">Alguna Vez</option>
                                                        <option value="4">A Menudo</option>
                                            ...
                                            <div class="row g-3 mt-2">
                                                <div class="col-md-12">
                                                    ...
                                                    <select id="pregunta-14" class="form-select primer-color-letra primer-color-fondo" required>
                                                        <option value="1">Casi Nunca</option>
                                                        <option value="2">Rara Vez</option>
                                                        <option value="3">Alguna Vez</option>
                                                        <option value="4">A Menudo</option>
                                            ...
                                            <div class="row g-3 mt-2">
                                                <div class="col-md-12">
                                                    ...
                                                    <select id="pregunta-15" class="form-select primer-color-letra primer-color-fondo" required>
                                                        <option value="1">Casi Nunca</option>
                                                        <option value="2">Rara Vez</option>
                                                        <option value="3">Alguna Vez</option>
                                                        <option value="4">A Menudo</option>
                                            ...
                                            <div class="row g-3 mt-2">
                                                <div class="col-md-12">
                                                    ...
                                                    <select id="pregunta-16" class="form-select primer-color-letra primer-color-fondo" required>
                                                        <option value="1">Casi Nunca</option>
                                                        <option value="2">Rara Vez</option>
                                                        <option value="3">Alguna Vez</option>
                                                        <option value="4">A Menudo</option>
                                            ...
                                            <div class="row g-3 mt-2">
                                                <div class="col-md-12">
                                                    ...
                                                    <select id="pregunta-17" class="form-select primer-color-letra primer-color-fondo" required>
                                                        <option value="1">Casi Nunca</option>
                                                        <option value="2">Rara Vez</option>
                                                        <option value="3">Alguna Vez</option>
                                                        <option value="4">A Menudo</option>
                                            ...
                                            <div class="row g-3 mt-2">
                                                <div class="col-md-12">
                                                    ...
                                                    <select id="pregunta-18" class="form-select primer-color-letra primer-color-fondo" required>
                                                        <option value="1">Casi Nunca</option>
                                                        <option value="2">Rara Vez</option>
                                                        <option value="3">Alguna Vez</option>
                                                        <option value="4">A Menudo</option>
                                            ...
                                            <div class="row g-3 mt-2">
                                                <div class="col-md-12">
                                                    ...
                                                    <select id="pregunta-19" class="form-select primer-color-letra primer-color-fondo" required>
                                                        <option value="1">Casi Nunca</option>
                                                        <option value="2">Rara Vez</option>
                                                        <option value="3">Alguna Vez</option>
                                                        <option value="4">A Menudo</option>
                                            ...
                                            <div class="row g-3 mt-2">
                                                <div class="col-md-12">
                                                    ...
                                                    <select id="pregunta-20" class="form-select primer-color-letra primer-color-fondo" required>
                                                        <option value="1">Casi Nunca</option>
                                                        <option value="2">Rara Vez</option>
                                                        <option value="3">Alguna Vez</option>
                                                        <option value="4">A Menudo</option>
                                            ...
                                            <div class="row g-3 mt-2">
                                                <div class="col-md-12">
                                                    <button type="submit" class="btn btn-lg primer-color-letra primer-color-fondo" id="contestar-cuestionario">✅ Contestar cuestionario y finalizar curso</button>
                                                </div>
                                            </div>
