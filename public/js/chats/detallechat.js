...
function GenerarMensajeEmisor(fechaRegistro, mensaje, nombreArchivo, nombreUsuarioEmisor, imagenEmisor) {
    ...
    if (nombreArchivo === undefined || nombreArchivo === null || nombreArchivo === '') {
        elemento = `<div class="col-md-12 d-flex justify-content-end"><div class="d-flex justify-content-start mb-4"><div class="card mask-custom"><div class="card-header d-flex justify-content-between p-2" style="border-bottom: 1px solid rgba(255,255,255,.3);"><div class="col-md-6 text-center text-wrap"><p class="text-start fw-bold mb-0 me-1">${nombreUsuarioEmisor}</p></div><div class="col-md-6 text-center text-wrap"><p class="text-light small mb-0 text-end"><i class="far fa-clock"></i>&nbsp;${fechaRegistro}</p></div></div><div class="card-body"><p class="mb-0">${mensaje}</p></div></div><img src="${imagenEmisor}" alt="avatar" class="m-2 rounded-circle d-flex align-self-start ms-3 shadow-1-strong" width="60" height="60"></div></div>`;
    } else {
        elemento = `<div class="col-md-12 d-flex justify-content-end"><div class="d-flex justify-content-start mb-4"><div class="card mask-custom"><div class="card-header d-flex justify-content-between p-2" style="border-bottom: 1px solid rgba(255,255,255,.3);"><div class="col-md-6 text-center text-wrap"><p class="text-start fw-bold mb-0 me-1">${nombreUsuarioEmisor}</p></div><div class="col-md-6 text-center text-wrap"><p class="text-light small mb-0 text-end"><i class="far fa-clock"></i>&nbsp;${fechaRegistro}</p></div></div><div class="card-body"><a download="${mensaje}" href="${nombreArchivo}" target="_blank"><i class="fa-solid fa-file-lines"></i>&nbsp;${mensaje}</a></div></div><img src="${imagenEmisor}" alt="avatar" class="m-2 rounded-circle d-flex align-self-start ms-3 shadow-1-strong" width="60" height="60"></div></div>`;
    }
...
function GenerarMensajeReceptor(fechaRegistro, mensaje, nombreArchivo, nombreUsuarioEmisor, imagenEmisor) {
    ...
    if (nombreArchivo === undefined || nombreArchivo === null || nombreArchivo === '') {
        elemento = `<div class="col-md-12 d-flex justify-content-start"><div class="d-flex justify-content-start mb-4"><img src="${imagenEmisor}" alt="avatar" class="m-2 rounded-circle d-flex align-self-start ms-3 shadow-1-strong" width="60" height="60"><div class="card mask-custom"><div class="card-header d-flex justify-content-between p-2" style="border-bottom: 1px solid rgba(255,255,255,.3);"><div class="col-md-6 text-center text-wrap"><p class="text-start fw-bold mb-0 me-1">${nombreUsuarioEmisor}</p></div><div class="col-md-6 text-center text-wrap"><p class="text-light small mb-0 text-end"><i class="far fa-clock"></i>&nbsp;${fechaRegistro}</p></div></div><div class="card-body"><p class="mb-0">${mensaje}</p></div></div></div></div>`;
    } else {
